  ...
  <div class="row">
    ...
    <div class="col-md-8">
      ...
      <img src="{{ Storage::url($post->images->first()->path) }}" class="card-img-top" alt="...">
        ...
        <!-- ?-> null safe operator -->
        <!-- <img src="{{ isset($post->images[0]) ? $post->images[0]->path : '' }}" class="card-img-top" alt="..."> -->
      ...
      <div class="card card-body mt-3">
        ...
        <div class="row">
          <div class="col-4 text-center">
            <img src="https://colorlibhub.com/sparkling/wp-content/uploads/sites/52/2013/01/Digital_Menu_Wordpress-1024x737.jpg" alt="" class="img-fluid">
          </div>
          <div class="col-8">
